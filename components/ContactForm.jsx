    ...
    try {
      const response = await fetch(leadEndpoint, {
        ...
        body: JSON.stringify({
          ...
          phone: data.get("phone"), services: data.getAll("services"), message: data.get("message"),
